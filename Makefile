...
LFLAGS=
DEPS=caffe_tokens.hpp caffe_grammar.hpp caffereader.hpp caffe_functors.hpp caffe_parse_tree_builder.hpp
OBJS=caffereader.o caffe_parse_tree_builder.o main.o
